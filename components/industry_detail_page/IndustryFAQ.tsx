...
const IndustryFAQ: React.FC<IndustryFAQProps> = ({ data }) => {
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
                <div className="grid md:grid-cols-12 gap-12">
                    <div className="md:col-span-4">
                        <span className="text-brand-primary font-bold uppercase tracking-widest text-xs mb-4 block">Support</span>
                        <h2 className="text-3xl font-bold font-heading text-brand-dark mb-6">{data.title}</h2>
                        <p className="text-brand-gray">
                            Clarifying the specifics of our industry engagement models.
                        </p>
                    </div>
