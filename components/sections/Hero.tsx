                ...
                <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
                    ...
                    <div className="lg:col-span-6 hero-content text-center lg:text-left">
                        ...
                        <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold font-heading text-brand-dark leading-tight tracking-tight mb-8">
                            Custom Software Development <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-primary to-brand-secondary">Services Company</span>
                        </h1>
                        <p className="text-lg text-brand-gray leading-relaxed mb-10 max-w-xl mx-auto lg:mx-0">
                            At Logic-unit, we build secure, scalable custom software development solutions for startups and enterprises.
                        </p>

                        <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-16">
                            <Link href="/services" className="inline-flex items-center justify-center rounded-full font-bold transition-all duration-300 shadow-lg hover:-translate-y-0.5 active:translate-y-0 px-8 py-3 text-lg bg-brand-primary text-white hover:bg-brand-dark hover:shadow-brand-primary/20">
                                Explore Capabilities
                            </Link>
                            <Link href="/contact" className="inline-flex items-center justify-center rounded-full font-bold transition-all duration-300 shadow-lg hover:-translate-y-0.5 active:translate-y-0 px-8 py-3 text-lg bg-white text-brand-dark border border-gray-200 hover:border-brand-primary hover:text-brand-primary">
                            ...
                            {CASE_STUDIES.map((study, index) => (
                                ...
                                >
                                    ...
                                    <div className="absolute bottom-0 left-0 right-0 p-8 md:p-12">
                                        <p className="text-brand-secondary font-bold text-sm uppercase tracking-widest mb-2">Impact Story</p>
