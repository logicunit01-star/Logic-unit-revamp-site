...
interface IndustryProcessProps {
    ...
    approaches: ProcessStep[];
}

const IndustryProcess: React.FC<IndustryProcessProps> = ({ approachTagline, approachHeading, approachHeadingSpan, approachContent, approaches }) => {
    return (
