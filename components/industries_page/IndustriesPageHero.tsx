...
const IndustriesPageHero: React.FC = () => {
                ...
                <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
                    ...
                    <div className="lg:col-span-6 hero-content text-center lg:text-left">
                        ...
                        <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold font-heading text-brand-dark leading-tight tracking-tight mb-8">
                            Transforming Global <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-primary to-brand-secondary">Industries</span>
                        </h1>
                        <p className="text-lg text-brand-gray leading-relaxed mb-10 max-w-xl mx-auto lg:mx-0">
                            At Logic-unit, we deliver innovative technology solutions tailored to the unique challenges of diverse sectors, driving growth and efficiency.
                        </p>

                        <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-16">
                            <Link href="#industries-grid" className="inline-flex items-center justify-center rounded-full font-bold transition-all duration-300 shadow-lg hover:-translate-y-0.5 active:translate-y-0 px-8 py-3 text-lg bg-brand-primary text-white hover:bg-brand-dark hover:shadow-brand-primary/20">
                                Explore Industries
                            </Link>
