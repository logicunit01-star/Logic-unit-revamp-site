            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 xl:gap-10">
                    {allStudies.map((study, index) => (
                        <div key={index} className="group bg-white rounded-2xl shadow-xl shadow-gray-200/40 overflow-hidden h-full border border-white hover:shadow-2xl hover:-translate-y-2 transition-all duration-500">
                            ...
                            <div className="p-8">
                                ...
                                <p className="text-brand-gray line-clamp-3 leading-relaxed">{study.description}</p>
