                            ...
                            {Array.from({ length: totalPages }).map((_, pageIndex) => (
                                <div key={pageIndex} className="w-full flex-shrink-0 grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
                                    {CASE_STUDIES.slice(pageIndex * slidesPerPage, (pageIndex + 1) * slidesPerPage).map((study, studyIndex) => (
                                        <div key={studyIndex} className="group h-full bg-white rounded-2xl overflow-hidden shadow-xl shadow-gray-200/50 border border-gray-100 hover:shadow-2xl hover:shadow-brand-primary/10 transition-all duration-500">
                                            ...
                                            <div className="p-8">
                                                ...
                                                <p className="text-brand-gray text-lg leading-relaxed">{study.description}</p>
