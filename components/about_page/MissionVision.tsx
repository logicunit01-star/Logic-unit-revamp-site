...
const MissionVision: React.FC = () => {
    return (
        <section id="mission" className="py-16 sm:py-24 bg-brand-bg-main scroll-mt-36">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    ...
                    <div>
                        <h2 className="text-3xl font-bold font-heading text-brand-dark mb-6">Mission & Vision</h2>
